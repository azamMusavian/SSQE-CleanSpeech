...
class TrainerAE(object):
    ...
    def save_checkpoint(self, checkpoint_path):
        ...
        """
        state_dict = {"optimizer": {"VQVAE": self.optimizer["VQVAE"].state_dict()},
                      "scheduler": {"VQVAE": self.scheduler["VQVAE"].state_dict()}, "steps": self.steps,
                      "epochs": self.epochs, "model": {
    ...
    def _train_epoch(self):
        ...
        for train_steps_per_epoch, batch in enumerate(self.data_loader["train"], 1):
            # train one step
            # data, data_shape, filename = batch
